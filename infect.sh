...
'
echo " " 
echo -e "$red                       ▶Coded by$grn 085$red◀$rset"
echo -e "$red                      ⫸$ylo  cayber 085$red ⫷$rset"
echo 
# Functions
...
'
echo " " 
echo -e "$red                       ▶Coded by$grn cayber$red◀$rset"
echo -e "$red                      ⫸$ylo  085 cayber$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [Infect them with fun]$rset"
echo " "
...
echo -e "\e[93m             IAM FROM \e[92mcayber085" | pv -qL 10
